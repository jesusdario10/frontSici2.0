...
@Component({
  selector: 'app-avance-cliente-ver',
  templateUrl: './avance-cliente-ver.component.html',
  styleUrls: ['./avance-cliente-ver.component.css']
})
export class AvanceClienteVerComponent implements OnInit {
   //Orden
